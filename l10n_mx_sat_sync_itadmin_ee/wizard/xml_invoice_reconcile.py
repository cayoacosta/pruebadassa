...
class XMLInvoiceReconcile(models.TransientModel):
    ...
    def action_reconcile(self):
        ...
        if payment:
            ...
            self.attachment_id.write({'creado_en_odoo':True, 'payment_ids':[(6,0, [payment.id])], 'res_id': payment.id, 'res_model': payment._name,'name': self.attachment_id.datas_fname}) #'invoice_ids':[(6,0, [invoice.id])], 
